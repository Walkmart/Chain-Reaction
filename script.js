...
function checkIfPlayedToday() {
    ...
    if (lastPlayed === today) {
        ...
        disableGame();  // Disable the game so they can't play
        return true;
    } else {
...
// Disable the game inputs if they have already played
function disableGame() {
    document.getElementById('guess-input').disabled = true;
    document.getElementById('submit-guess').disabled = true;
    document.getElementById('hint-btn').disabled = true;
    const gameContainer = document.querySelector('.game-container');
    gameContainer.style.opacity = 0.5;  // Make the game container less visible to indicate it's disabled
}
